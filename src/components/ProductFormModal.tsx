                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        onBlur={handleBlur}
                                        disabled={isSubmitting}
                                        className={`w-full px-4 py-2.5 rounded-lg border-2 transition-all outline-none disabled:opacity-50 disabled:cursor-not-allowed ${errors.title && touched.title
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        disabled={isSubmitting}
                                        rows={3}
                                        className={`w-full px-4 py-2.5 rounded-lg border-2 transition-all outline-none resize-none disabled:opacity-50 disabled:cursor-not-allowed ${errors.description && touched.description
                                                ? 'border-red-500 focus:border-red-600'
                                                : 'border-gray-300 focus:border-purple-500'
                                            }`}
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <select
                                            ...
                                            onBlur={handleBlur}
                                            disabled={isSubmitting}
                                            className={`w-full px-4 py-2.5 rounded-lg border-2 transition-all outline-none disabled:opacity-50 disabled:cursor-not-allowed ${errors.category && touched.category
                                                    ? 'border-red-500 focus:border-red-600'
                                                    : 'border-gray-300 focus:border-purple-500'
                                                }`}
                                        >
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onBlur={handleBlur}
                                            disabled={isSubmitting}
                                            className={`w-full px-4 py-2.5 rounded-lg border-2 transition-all outline-none disabled:opacity-50 disabled:cursor-not-allowed ${errors.brand && touched.brand
                                                    ? 'border-red-500 focus:border-red-600'
                                                    : 'border-gray-300 focus:border-purple-500'
                                                }`}
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            min="0"
                                            step="0.01"
                                            className={`w-full px-4 py-2.5 rounded-lg border-2 transition-all outline-none disabled:opacity-50 disabled:cursor-not-allowed ${errors.price && touched.price
                                                    ? 'border-red-500 focus:border-red-600'
                                                    : 'border-gray-300 focus:border-purple-500'
                                                }`}
                                            placeholder="0.00"
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            min="0"
                                            step="1"
                                            className={`w-full px-4 py-2.5 rounded-lg border-2 transition-all outline-none disabled:opacity-50 disabled:cursor-not-allowed ${errors.stock && touched.stock
                                                    ? 'border-red-500 focus:border-red-600'
                                                    : 'border-gray-300 focus:border-purple-500'
                                                }`}
                                            placeholder="0"
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            max="100"
                                            step="0.1"
                                            className={`w-full px-4 py-2.5 rounded-lg border-2 transition-all outline-none disabled:opacity-50 disabled:cursor-not-allowed ${errors.discountPercentage && touched.discountPercentage
                                                    ? 'border-red-500 focus:border-red-600'
                                                    : 'border-gray-300 focus:border-purple-500'
                                                }`}
                                            placeholder="0"
